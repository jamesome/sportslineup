<?php
    ...
    $com['is_mobile'] = (get_isMobile($_SERVER['HTTP_USER_AGENT']) == 'Y' ? true : false);
    $cfg_upfile_size = ($com['upfile_size'] ? intval(($com['upfile_size'])/(1024*1024*1024)):'50');
?>
<!DOCTYPE html>
<html lang="ko">
<head>
...
#addInputBox {width: 80px;height: 28px;padding: 0;overflow: hidden;clip:rect(0,0,0,0);border: 0;}

.pop_container .filebox {position: absolute; top:47px; right: 40px}
.filebox input[type="file"] {position: absolute;width: 1px;height: 1px;padding: 0;margin: -1px;overflow: hidden;clip:rect(0,0,0,0);border: 0;}
.filebox label {display: inline-block;color: #999;font-size: inherit;line-height: normal;vertical-align: middle;cursor: pointer;}

:root  .upload{padding:6px 0 2px 6px;}
</style>

<script type="text/javascript">
    var g_mobile = '<?=$com['is_mobile']?>';
</script>
</head>
<body>
<div id="pop_wrap">
    ...
    <div id="pop_container" class="pop_container" style="display:none;">
        ...
        <div id="pop_content">
            ...
            <!--input type="file" class="upload" id="addInputBox" name="Filedata" onchange="addUploadfiles(this)"-->
            <div class="filebox bs3-primary">
                <label for="addInputBox"><img src="./img/btn_find.png" width="65" height="25" alt="파일찾기"></label>
                <input type="file" name="Filedata" id="addInputBox" accept='image/*' class="upload" onchange='addUploadfiles(this)'>            
		    </div>
            ...
            <p class="dsc dsc_v1">찾아보기를 클릭후 이미지 선택 추가해 주세요.<br><em>한 장당 10MB, 1회에 <?=$cfg_upfile_size?>B까지, 10개</em>의 이미지 파일을<br>등록할 수 있습니다. (JPG, GIF, PNG, BMP)</p>
        </div>
        <!-- //content -->
    </div>
...
<script type="text/javascript" src="attach_photo.js?v=20170118" charset="utf-8"></script>
